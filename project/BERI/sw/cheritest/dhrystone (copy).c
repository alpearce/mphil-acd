...
int Proc1(char * PtrParIn);
int Proc2(int IntParIO);
int Proc3(char * PtrParOut);
int Proc4();
int Proc5();
int Proc6(int EnumParIn, int EnumParOut);
int Proc7(int IntParI1, int IntParI2, int IntParOut);
int Proc8(char *, char *, int IntParI1, int IntParI2);
